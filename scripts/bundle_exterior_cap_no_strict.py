...
OUT = ROOT / 'exterior_cap_no_strict_packet'
TARGET = 'Solutions.Sol_Hirsch_exterior_cap_clip_diameter_no_strict'
...
def main() -> None:
    ...
    manifest = {
        ...
        'proposed_theorem_name': 'Hirsch.simultaneous_clip_diameter_of_exterior_cap_without_strict_centre',
        'formal_scope': 'EXTERIOR_CAP_WITNESS_WITHOUT_SEPARATE_STRICT_CENTRE',
