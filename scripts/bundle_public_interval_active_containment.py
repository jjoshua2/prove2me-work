...
ROOT=Path(__file__).resolve().parents[1]; OUT=ROOT/'public_interval_active_containment_packet'
TARGET='Solutions.Sol_Hirsch_face_interval_active_containment_route_bound'; PIN='c5ea00351c28e24afc9f0f84379aa41082b1188f'; ALLOWED={'Mathlib','Definitions.Def_Hirsch_model'}
def main():
