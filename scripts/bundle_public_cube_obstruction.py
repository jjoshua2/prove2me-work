...
ROOT=Path(__file__).resolve().parents[1]; OUT=ROOT/'public_cube_obstruction_packet'
TARGET='Solutions.Sol_Hirsch_crossing_cube_endpoint_obstruction'; PIN='c5ea00351c28e24afc9f0f84379aa41082b1188f'; ALLOWED={'Mathlib','Definitions.Def_Hirsch_model'}
def main():
