...
TARGET = "Solutions.Sol_Hirsch_common_face_dimension_tradeoff"
...
# The public definition is deliberately external to the flattened proof.
...
print(OUT)
print('SOLUTION_SHA256', hashlib.sha256(bundle.encode()).hexdigest())
