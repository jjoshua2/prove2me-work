#!/usr/bin/env python3
"""Build a source-faithful, focused-import standalone deletion-savings proof.

All repository-local definition/proof bodies are retained, with file-local
sections closed explicitly. Only imports and dependency axiom-print commands
are replaced. Focused Mathlib imports avoid loading the entire library in
memory-constrained workspaces. No network, credentials, or theorem stubs.
"""
...
TARGET='Solutions.PolynomialCircuitDeletionSavings'
