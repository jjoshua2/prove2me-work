...
inward old-active-kernel direction.  The resulting point is an old vertex and
lies strictly below the cap. -/
theorem new_horizon_first_hit_old_vertex
  ...
  have hyCap : ⟪capNormal a, y⟫ < T := by
    ...
    linarith
  exact ⟨r, t, hr0, htpos, hrActive, hrCap, hyExtreme, hyCap⟩
