...
/-- A target-only two-level condition gives a constructed original-edge Hirsch
bound. Each step preserves every acquired target row and acquires a new one. -/
...
#print axioms Hirsch.TargetRows.extreme_kernel
#print axioms Hirsch.TargetRows.active_card
#print axioms Hirsch.TargetRows.locked_face
#print axioms Hirsch.TargetRows.acquiring_step
#print axioms Hirsch.TargetRows.locked_route
